    ...
    <div class="content-box">
        <div class="content-box-header">
            ...
            <div class="content-box-btn">
                @can('cursos.create')
                    <a href="{{ route('cursos.create') }}" class="flex items-center space-x-1 btn-success">
                            ...
                            <tr class="table-row-body">
                                ...
                                <td class="table-actions">
                                    <div class="table-actions-align">
                                        ...
                                        @can('cursos.destroy')
                                            <form action="{{ route('cursos.destroy', $d->id) }}" method="POST"
        ...
        @else
            ...
            <div class="flex flex-col items-center justify-center py-20 text-center text-gray-500">
                ...
                <p class="text-sm text-gray-400">Tente ajustar os filtros de pesquisa ou adicione um novo curso.</p>
            </div>
        @endif
