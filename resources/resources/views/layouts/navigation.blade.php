    ...
    <div class="navbar-container">
        ...
        <div class="flex items-center gap-4 user-container">
            ...
            <div id="dropdownContent"
                class="absolute z-50 hidden w-48 bg-white rounded-md shadow-lg right-2 mt-28 dark:bg-cor-dark-primary">
                ...
                <a href="{{ route('logout') }}"
                    ...
                    class="block px-4 py-2 text-sm text-red-500 bg-red-50 hover:bg-red-100 hover:text-red-700 dark:text-red-500 dark:bg-cor-dark-primary dark:hover:hover:bg-cor-dark-secondary dark:hover:text-red-600">
                    Sair
                </a>
            </div>
