    ...
    <div class="sidebar-container">
        ...
        <nav class="sidebar-nav">
            ...
            @can('dashboard')
                ...
                <a @class(['sidebar-link', 'active' => Route::is('dashboard')]) href="{{ route('dashboard') }}">
            ...
            @can('cursos-index')
                <!-- Ícone home (Heroicons) -->
                <a href="{{ route('cursos.index') }}" class="sidebar-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="size-4">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
            ...
            @can('user-status-index')
                <a href="{{ route('user_statuses.index') }}" class="sidebar-link">
            ...
            @can('audit-index')
                <a href="{{ route('audits.index') }}" class="sidebar-link">
                    <!-- Ícone exclamation-triangle (Heroicons) -->
            ...
            @can('translation-index')
                <a href="{{ route('translations.index') }}" class="sidebar-link">
                    <!-- Ícone exclamation-triangle (Heroicons) -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="size-4">
                        <path fill-rule="evenodd"
