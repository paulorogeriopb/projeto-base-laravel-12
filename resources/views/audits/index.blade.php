    ...
    <div class="content-box">
        ...
        <form method="GET" action="{{ route('audits.index') }}" class="flex flex-wrap items-end w-full gap-2 md:flex-nowrap">
            ...
            <div class="flex w-full gap-2 md:w-auto">
                <button type="submit" class="items-center justify-center w-full h-10 px-4 md:w-44 btn-primary">
                ...
                <a href="{{ url()->current() }}" class="items-center justify-center w-full h-10 px-4 md:w-44 btn-warning">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
